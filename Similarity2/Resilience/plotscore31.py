...
file_softsort_normal = 'softsort_normal_epoch_350_lr_1e-06_20241127_180601'
...
# plt.title('Rg')
# plt.savefig('./scores_save/3r_select_'+str(r_select)+'.svg', format='svg')
plt.savefig('./scores_save/3y_select_'+str(r_select)+'_'+file_softsort_normal+'.svg', format='svg')
plt.show()
